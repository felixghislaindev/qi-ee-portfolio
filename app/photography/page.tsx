...
export default function PhotographyPage() {
  ...
  const { images, loading, error, getImageUrl, isUsingCloudinary } =
    ...
    <div className="min-h-screen pt-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="text-center">
            <h1 className="text-5xl sm:text-6xl font-bold mb-6 bold-artistic">
              Photography
            </h1>
            <p className="text-lg artistic-text text-muted-foreground max-w-2xl mx-auto">
              A comprehensive collection of my photographic work, spanning
            ...
            >
              <div className="relative overflow-hidden bg-muted aspect-[4/5]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  {/* <h3 className="text-white font-semibold bold-artistic mb-1">
                    {item.title}
                  </h3> */}
                  <p className="text-white/80 text-sm artistic-text">
                    {item.description}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4">
                <div className="flex justify-between items-start mb-2">
                  {/* <h3 className="text-lg font-semibold bold-artistic">
                    {item.title}
                  </h3> */}
